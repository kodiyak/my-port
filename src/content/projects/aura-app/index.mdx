---
name: "Aura App"
description: "Um sistema de pedidos e faturamento para um ateliê de costura real que trabalha para confecções (B2B)."
---
...
<AssetVideo src="./assets/aura-v0-pt1.mp4" caption="Demonstração v0 — parte 1" />

<AssetVideo src="./assets/aura-v0-pt2.mp4" caption="Demonstração v0 — parte 2" />
